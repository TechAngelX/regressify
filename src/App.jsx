...
const AppContent = () => {
  ...
  return (
    <div className={`w-full min-h-screen p-8 transition-colors duration-300 ${bg}`}>
      ...
      {/* PAGE TITLE */}
      <h1 className={`text-3xl font-bold text-center mb-2 mt-12 ${text}`}>Salary Prediction: ML Methods Compared</h1>
      <div className="max-w-2xl mx-auto text-center mb-6">
        ...
        <p className={`font-medium ${textMuted}`}>I created this cheat sheet to explore how different algorithms "think" about the same data.</p>
      </div>
      ...
      <div className="max-w-6xl mx-auto mb-8">
        ...
        <p className={`text-center text-sm mt-3 ${textMuted}`}>
          {activeTab === 'regression' 
            ? 'Predicting continuous values (e.g., salary in GBP)' 
